...
- **equilibrator_api cache:** Downloads a cache file (~130 MB) to `data/Input_Files/equilibrator_cache/` on first run (configured in `Competencies.py` via environment variables)
