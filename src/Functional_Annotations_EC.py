...
def main():
    ...
    # duckdb_load_table(conn, "./src/Input_Files/merged-kg/merged-kg_edges.tsv", "edges", ["subject", "object"])
    duckdb_load_table(conn, "./src/Input_Files/kg-microbe-biomedical-function/merged-kg_edges.tsv", "edges", ["subject", "object"])
    conditions = [
        ('UniprotKB:%', 'Proteomes:%'),
        ('Proteomes:%', 'NCBITaxon:%'),
        ('UniprotKB:%', 'EC:%')
    ...
    output_table_to_file(conn, "ncbitaxon_ec", "./src/Intermediate_Files/NCBITaxon_to_EC.tsv")
