...
SELECT *
  ...
  WHERE (subject_prefix = 'NCBITaxon' OR subject_prefix = 'strain')
     AND object_name = 'butyrate'; -- 'butyrate' 'tryptophan'

COPY (SELECT subject, object_name FROM metabolite_edges) TO '/Users/brooksantangelo/Documents/Repositories/kg-microbe-projects/kg_microbe_paper_2024/Scripts/Intermediate_Files_Competencies/butyrate/NCBI_organismal_traits.tsv' (FORMAT 'csv', DELIMITER '\t', HEADER TRUE);
